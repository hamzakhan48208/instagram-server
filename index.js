...
app.use(cors({methods: ["POST", "GET", "PUT", "DELETE"], origin: ['https://instagram-frontend-sigma.vercel.app']}));

app.use(function(req, res, next){
  // res.setHeader('Access-Control-Allow-Origin', 'http://localhost:4200');
  res.setHeader('Access-Control-Allow-Origin', 'https://instagram-frontend-sigma.vercel.app');
